...
func (k *ExtendedKey) Child(i uint32) (*ExtendedKey, error) {
	...
	parentFP := aibutil.Hash160(k.pubKeyBytes())[:4]
...
func (k *ExtendedKey) Address(net *chaincfg.Params) (*aibutil.AddressPubKeyHash, error) {
	pkHash := aibutil.Hash160(k.pubKeyBytes())
	return aibutil.NewAddressPubKeyHash(pkHash, net)
}
