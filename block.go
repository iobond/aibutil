...
// Tx returns a wrapped transaction (aibutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (aibutil.Tx) for all
...
// instead provides easy access to wrapped versions (aibutil.Tx) of them.
